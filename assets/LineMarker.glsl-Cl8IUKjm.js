import{wh as X,Hs as Z,Ht as ee,G3 as te,G1 as ie,Hu as re,Hv as ae,G8 as o,Hl as se,GH as oe,Hk as ne,G7 as w,Hw as ce,Hx as le,G4 as pe,G6 as de,G9 as he,H4 as ve,Gb as ue,Hy as A,Hz as F,HA as me,HB as fe,GL as ge,f$ as Se,Gc as Pe,Gd as ye,_ as _e,Ge as L,Gf as N,Gg as we,Gh as R,Gi as M,GN as ze,Gk as xe,Gl as $e,Gm as be,Go as V,Gp as Te,HC as Ve,HD as E,HE as U,HF as ke,HG as Oe,HH as De,Gq as Ce,n as p,Gr as d,fY as We,GO as Le,HI as I,qR as Me,Hc as Ge,l5 as je,Gw as He,ce as B,yj as Ae,gx as q,cp as Y,HJ as Fe}from"./index-BIS0uLzm.js";function J(r){const e=new X,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(Z,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
